...
*******************************************************************************************************/
#define RXpin 16              //this is the pin that the Arduino will use to receive data from the GPS
#define TXpin 17              //this is the pin that the Arduino can use to send data (commands) to the GPS - not used
